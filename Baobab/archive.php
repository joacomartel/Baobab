	...
	<div id="pagewrap">
		...
		<div class="portada">
			...
			<div class="about">
				...
				<p>Una <span>Noticia</span> es una publicación de carácter oficial del equipo administrador de tu comunidad.</p>
				<?php if ( is_user_logged_in() ) {}
				else {echo "<a href='".site_url()."/wp-login.php' class='button color_blue'>Inicia Sesión</a>";}
				?>
				<?php global $current_user; get_currentuserinfo(); if ($current_user->user_level == 10 ) { ?>
				<?php echo "<a href='".site_url()."/wp-admin/post-new.php' class='button color_blue'>Crear Noticia</a>"; ?>
				<?php } ?>
			</div><!-- about -->
				...
				<figure class="item block">
					...
					<figcaption id="clickeable" onclick="location.href='<?php the_permalink(); ?>';" style="cursor:pointer;">
						<a href="<?php the_permalink(); ?>">
							...
							echo ''.wp_limit_post(25, '...', true);;
							}
							?>"
							<span><?php echo get_comments_number( $post_id ).' Comentarios'; ?></span>
							</p>
						</a>
					</figcaption>
