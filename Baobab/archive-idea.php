...
<content>
	<div id="pagewrap">
		...
		<div class="portada">
			...
			<div class="about">
				<img src="<?php bloginfo('stylesheet_directory'); ?>/images/portada-idea.png"/>
				<p>Una <span>Idea</span> puede convertirse en un gran proyecto. ¡Compártela!</p>
				<?php if ( is_user_logged_in() ) { echo '<a href="/enviar-idea/" class="button color_blue">Crear Idea</a>'; }
