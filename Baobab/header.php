...
<a href="/sugerencias/" class="button color_red">Enviar Sugerencia</a>
<header>
	<div id="pagewrap">
		<a href="/index.php"><img src="<?php header_image(); ?>" width="<?php echo HEADER_IMAGE_WIDTH; ?>" height="<?php echo HEADER_IMAGE_HEIGHT; ?>" alt="" /></a>
		<h1><a href="/index.php"><?php bloginfo('title');?></a></h1>
		<div class="group-header">
			...
			<?php if ( is_user_logged_in()) { echo ''; } else { echo '<a href="/wp-login.php">Iniciar Sesión</a>'; };?>
			</nav> <!-- login -->
