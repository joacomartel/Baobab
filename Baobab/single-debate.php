	...
	<div id="pagewrap">
     ...
     <div id="chart_div" style="width: auto; height: auto;"></div>
     	<?php } ?>
			...
			<p class="edit">
			<?php if ($post->post_author == $current_user->ID){ ?><a href="<?php echo get_permalink_by_postname('enviar-debate'); ?>?&id=<?php the_ID(); ?>">editar</a><?php } ?>
			</p>
		...
		<aside id="archive-list">
				<?php if ( is_user_logged_in() ) { echo "<a href='".get_permalink_by_postname('enviar-debate')."' class='button color_blue'>Crear Debate</a>";} ?>
			<h2>Ultimos Debates</h2>
			<?php listar_debates ();?>
		</aside><!-- archive-list -->
