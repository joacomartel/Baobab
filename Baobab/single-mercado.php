		...
		<article id="publicacion">
			...
			<ul class="info second">
				...
				<li>
					...
					<h3>Contacto</h3><br>
				<!-- Usuario Logueado puede enviar mail --><?php if (is_user_logged_in()){ ?><a class="boton color_green" href="mailto:<?php the_author_email(); ?>">Enviar Mensaje</a><?php } ?>
				<!-- Usuario NO-Logueado puede NO puede enviar mail --><?php if ( is_user_logged_in() ) { echo ''; } else { echo 'Para ponerte en contacto debes <a href="/wp-login.php">Iniciar Sesión</a>.'; }?>
				</li>
			</ul>
