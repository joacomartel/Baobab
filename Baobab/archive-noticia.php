	...
	<div id="pagewrap">
		...
		<div class="portada">
			...
			<div class="about">
				...
				<p>En una <span>Noticia</span> puedes informar a la comunidad sobre algún hecho relevante. ¡Difunde!</p>
		...
		<?php $noticias = new WP_Query('post_type=noticia&offset=-1&posts_per_page=100');if ( $noticias->have_posts() ) : while ( $noticias->have_posts() ) : $noticias->the_post(); ?>
