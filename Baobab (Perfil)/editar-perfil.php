...
<div id="pagewrap">
	<div class="profile-info">
			...
			<form action="" method="post">
				...
				<input type="text" name="email" placeholder="<?php _e("Correo Electrónico (obligatorio)", "Baobab");?>" value="<?php echo $user_info->user_email; ?>"/><br />
				<textarea name="desc" placeholder="<?php _e("Biografía", "Baobab");?>" rows="5"><?php echo $user_info->description; ?></textarea> <br />
				<img src="<?php bloginfo('stylesheet_directory'); ?>/images/link2.png"></img><input type="text" name="website" placeholder="<?php _e("Sitio web", "Baobab");?>" value="<?php echo $user_info->user_url; ?>"/>				
				<img src="<?php bloginfo('stylesheet_directory'); ?>/images/twitter2.png"></img><input  name="twitter" type="text" id="twitter" placeholder="<?php _e("@usuario","Baobab");?>" value="<?php the_author_meta( 'twitter', $current_user->id ); ?>"/>
				<img src="<?php bloginfo('stylesheet_directory'); ?>/images/fb2.png"></img><input name="facebook" type="text" id="facebook" placeholder="<?php _e("www.facebook.com/tu-usuario","Baobab");?>" value="<?php the_author_meta( 'facebook', $current_user->id ); ?>"/>				
				
				

				<h4><?php _e("Contraseña","Baobab");?></h4>
				<?php _e("Si quieres cambiar tu contraseña, escribe en los siguientes campos. De lo contrario, déjalo en blanco","Baobab");?>
				...
				<br/><br />
				<input type="submit" name="submit" value="<?php _e("Actualizar Perfil","Baobab"); ?>" id="submit" class="button color_la"/>
			</form>
	...
	$redirect_to = get_bloginfo('url')."/login";
