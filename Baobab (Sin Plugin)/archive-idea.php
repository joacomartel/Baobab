	...
	<div id="pagewrap">
		...
		<div class="portada">
			...
			<div class="about">
				...
				<?php _e("<p>Una <span>Idea</span> puede convertirse en un gran proyecto. ¡Compártela!</p>", "Baobab"); ?>
				<?php if ( is_user_logged_in() ) { echo "<a href='".esc_url( get_permalink( get_page_by_title( __("Enviar Idea", "Baobab"))))."' class='button color_blue'>"; echo _e("Crear Idea</a>", "Baobab"); }
